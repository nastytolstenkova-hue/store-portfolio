...
export default function NotFoundPage(){
  return (
    <div className="min-h-[80vh] flex flex-col items-center justify-center text-center px-4">
      <h1 className="text-[12rem] lg:text-[18rem] font-bold text-zinc-100 leading-none select-none">
        oops!
      </h1>
      <div className="absolute flex flex-col items-center">
        <h2 className="text-zinc-800 font-mono font-bold text-5xl uppercase tracking-[0.2em] mb-4">This page doesn't exist</h2>
