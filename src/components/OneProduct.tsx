...
export default function OneProduct({product}:{product:IProduct}){
  const {addCartProduct, countCartProduct, countSummaryPrice} = UseProductContext()
